<template>
    <div class=" text-principal-font backdrop-blur-md p-5 fixed block md:flex md:justify-end md:items-center md:gap-4 w-full z-50">
        <ul class="social-links flex flex-col md:flex-row justify-end gap-4">
            <li>
